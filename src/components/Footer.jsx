    ...
    <footer className="footer-container">
      <div className="footer-main-area">
        ...
        <div>
          ...
          <small>Refund & Cancellation</small>
          <small>Privacy Policy</small>
        </div>
      </div>
      <hr />
      <div className="footer-copyright-socialMediaLinks">
        <h3>
          <span>Designed and Developed by</span>
          <a href="https://www.linkedin.com/in/jyotsnamehta24/" target="_blank">
            Jyotsna Mehta
          </a>
        </h3>
